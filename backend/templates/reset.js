module.exports = function reset(firstName,lastName,token,id){
                      ...
                      <div style="width: 100% !important;">
                        ...
                        <div style="padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;">
                          ...
                          <table style="font-family:'Cabin',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                            <tbody>
                              <tr>
                                <td style="overflow-wrap:break-word;word-break:break-word;padding:20px 20px;font-family:'Cabin',sans-serif;" align="left">
    
                                <div style='font-family:arial;'><p>Bonjour ${firstName} ${lastName}, </p><br/><p> Nous avons reçu une demande de réinitialisation de votre mot de passe Soomy. Veuillez cliquer sur le lien suivant pour changer votre mot de passe . </p><hr></div>
                              ...
                              <tr>
                                <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;" align="left">
                                  ...
                                  <div align="center">
                                    ...
                                    <a href="https://soomy.tn/validate?id=${id}&token=${token}" target="_blank" >
                                      <span style="display:block;padding:14px 44px 13px;line-height:120%;"><span style="font-size: 16px; line-height: 19.2px;"><strong><span style="line-height: 19.2px; font-size: 16px;">Cliquez ici pour réinisialiser votre mot de passe</span></strong>
                                      </span>
                                      </span>
                                    </a>
