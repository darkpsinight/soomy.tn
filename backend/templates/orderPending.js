...
module.exports= function orderPending(nom,prenom,name,prix,prixPromo,room_id){
                              ...
                              <tr>
                                <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;" align="left">
                                  ...
                                  <div style="line-height: 160%; text-align: center; word-wrap: break-word;">
                                    <p style="font-size: 14px; line-height: 160%;"><span style="font-size: 22px; line-height: 35.2px; font-family: Rubik, sans-serif;">Bonjour ${nom} ${prenom}, </span></p>
                                    ...
                                    Afin de vous livrer le produit que vous avez remporté.
Nous vous invitons à confirmer votre commande d'ici le ${format(new Date().setDate(new Date().getDate() + 14),"HH:mm,dd/MM/yyyy")}</span></span>
                                    </p>
                                  </div>
    ...
    <table style="width:80%;margin:10px auto;font-size: 16px;">
    <thead>
                              ...
                              <tr>
                                <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;" align="left">
                                  ...
                                  <div align="center">
                                    ...
                                    <a href="https://soomy.tn/checkout/${room_id}" target="_blank" style="box-sizing: border-box;display: inline-block;font-family:'Cabin',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #f5274c; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;">
                                      <span style="display:block;padding:14px 44px 13px;line-height:120%;"><span style="font-size: 16px; line-height: 19.2px;"><strong><span style="line-height: 19.2px; font-size: 16px;">Confirmer ma commande</span></strong>
                                      </span>
                                      </span>
                                    </a>
