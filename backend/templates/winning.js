module.exports= function winning(name,product,prix,prixPromo,category,room_id){
                              ...
                              <tr>
                                <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;" align="left">
                                  ...
                                  <div style="line-height: 160%; text-align: center; word-wrap: break-word;">
                                    <p style="font-size: 14px; line-height: 160%;"><span style="font-size: 22px; line-height: 35.2px; font-family: Rubik, sans-serif;">Félicitations ${name}! </span></p>
...
Vous avez gagné l'enchère suivante :</span></span>
                                    </p>
                                  </div>
    ...
    <table style="width:90%;margin:10px auto;font-size: 16px;">
    <thead>
        <tr style="height:50px; background-color:#e5e5e5; border: white 1px solid;text-align:center">
                              ...
                              <tr>
                                <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;" align="left">
                                  ...
                                  <div align="center">
                                    ...
                                    <a href="${(category ==="premium")?("https://soomy.tn/premiumProduct/"+room_id.toString()):("https://soomy.tn/product/"+room_id.toString())}" target="_blank" style="box-sizing: border-box;display: inline-block;font-family:'Cabin',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #f5274c; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;">
                                      <span style="display:block;padding:14px 44px 13px;line-height:120%;"><span style="font-size: 16px; line-height: 19.2px;"><strong><span style="line-height: 19.2px; font-size: 16px;">Allez à Enchère</span></strong>
                                      </span>
                                      </span>
                                    </a>
                                  ...
                                  <div align="center">
                                    <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;font-family:'Cabin',sans-serif;"><tr><td style="font-family:'Cabin',sans-serif;" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="" style="height:46px; v-text-anchor:middle; width:174px;" arcsize="8.5%" stroke="f" fillcolor="#f5274c"><w:anchorlock/><center style="color:#FFFFFF;font-family:'Cabin',sans-serif;"><![endif]-->
                                    <h6>Vous allez recevoir un deuxième E-mail, vous détaillant
la marche à suivre pour obtenir votre produit</h6>
                                    <!--[if mso]></center></v:roundrect></td></tr></table><![endif]-->
                                  </div>
